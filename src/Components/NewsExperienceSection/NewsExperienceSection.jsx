  ...
  return (
    <section className="mt-[9rem]">
      ...
      <div className="mt-1 overflow-hidden">
        ...
        >
          {newExperienceResturantData.map((item) => (
            <SwiperSlide key={item.resturantName} className="py-6">
              <div className="bg-white relative w-[50%px] h-[420px] rounded-medium flex flex-col items-center justify-start cursor-pointer Card-Shadow2 hover:Card-Shadow3">
