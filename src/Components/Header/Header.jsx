...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 left-0 z-50">
      <div className="h-[4rem] flex items-center justify-between px-2 relative bg-white">
        <div className="w-[33.33%] flex justify-start items-center gap-5">
          ...
          <div className="flex justify-start items-center gap-2">
            ...
            <BsChevronDown
              onClick={() => setModalTwoIsOpen(!modalTwoIsOpen)}
        ...
        <div
          onClick={() => setModalOneIsOpen(!modalOneIsOpen)}
        ...
        <div className="w-[33.33%] lg:hidden flex justify-end items-center gap-3">
          ...
          />
          <RxPerson
            onClick={() => setModalThreeIsOpen(!modalThreeIsOpen)}
            className="text-medium cursor-pointer"
          />
        </div>
      ...
      {modalOneIsOpen && (
        <Modal setModalOneIsOpen={setModalOneIsOpen}>
          <div
            onClick={() => setModalOneIsOpen(!modalOneIsOpen)}
            className="flex justify-center items-center gap-2 opacity-1 mt-2">
      ...
      {modalTwoIsOpen && (
        <Modal>
          <div className="flex justify-center items-center h-screen">
            <div className="w-[30rem] md:w-[35rem] lg:w-[38rem] h-[75vh] bg-white rounded-medium p-3 flex flex-col justify-between items-center gap-2 Card-Shadow">
        ...
        <Modal>
          <div className="flex justify-center items-center h-screen">
            <div className="w-[30rem] h-[340px] bg-white rounded-medium p-3 flex flex-col justify-between items-start Card-Shadow">
              ...
              <button className="w-full h-[3rem] bg-[hsl(321,100%,50%)] rounded-medium text-xl font-bold text-white">
                تایید
              </button>
            </div>
          </div>
